...
const COMMON_FOODS = [
  ["chicken-breast-raw", "Chicken breast, raw, skinless", "", 120, 23, 0, 2.6, "uncooked chicken meat", 150],
  ["chicken-breast", "Chicken breast, cooked", "", 165, 31, 0, 3.6, "chicken grilled roasted skinless", 150],
  ["chicken-thigh-raw", "Chicken thigh, raw, skinless", "", 144, 19, 0, 7.5, "uncooked chicken dark meat", 150],
  ["chicken-thigh", "Chicken thigh, cooked, skinless", "", 209, 26, 0, 10.9, "chicken dark meat", 150],
  ["chicken-thigh-skin-raw", "Chicken thigh, raw, with skin", "", 211, 17, 0, 16, "uncooked chicken dark meat skin on", 150],
  ["chicken-thigh-skin", "Chicken thigh, cooked, with skin", "", 232, 23, 0, 15, "chicken dark meat skin on", 150],
  ["lean-beef-mince-raw", "Lean beef mince, raw", "", 172, 21, 0, 9, "uncooked ground beef mince", 150],
  ["lean-beef-mince", "Lean beef mince, cooked", "", 215, 26, 0, 12],
  ["extra-lean-beef-mince-raw", "Extra-lean beef mince, raw", "", 137, 21, 0, 5, "uncooked mince beef 5 percent fat", 150],
  ["extra-lean-beef-mince", "Extra-lean beef mince, cooked", "", 176, 27, 0, 7, "mince beef 5 percent fat", 150],
  ["regular-beef-mince-raw", "Regular beef mince, raw", "", 215, 19, 0, 15, "uncooked ground beef mince", 150],
  ...
  ["salmon-raw", "Salmon, raw", "", 208, 20, 0, 13, "uncooked fish seafood", 150],
  ...
  ["beef-rump-raw", "Beef rump steak, raw", "", 198, 21, 0, 12, "uncooked steak braai meat", 150],
  ["beef-rump", "Beef rump steak, cooked", "", 250, 27, 0, 16, "steak braai meat", 150],
  ["beef-sirloin-raw", "Beef sirloin steak, raw", "", 201, 21, 0, 13, "uncooked steak braai meat", 150],
  ["beef-sirloin", "Beef sirloin steak, cooked", "", 242, 27, 0, 15, "steak braai meat", 150],
  ["beef-fillet-raw", "Beef fillet steak, raw", "", 167, 22, 0, 8, "uncooked steak tenderloin meat", 150],
  ["beef-fillet", "Beef fillet steak, cooked", "", 218, 29, 0, 11, "steak tenderloin meat", 150],
  ["pork-chop-raw", "Pork chop, raw", "", 211, 19, 0, 15, "uncooked pork meat braai", 150],
  ["pork-chop", "Pork chop, cooked", "", 240, 27, 0, 14, "pork meat braai", 150],
  ["lamb-chop-raw", "Lamb chop, raw", "", 253, 18, 0, 20, "uncooked lamb meat braai", 120],
  ["lamb-chop", "Lamb chop, cooked", "", 280, 25, 0, 20, "lamb meat braai", 120],
  ["hake-raw", "Hake, raw", "", 90, 20, 0, 1.3, "uncooked fish seafood", 150],
  ...
  ["chicken-drumstick-raw", "Chicken drumstick, raw, skinless", "", 155, 19, 0, 8.5, "uncooked chicken meat", 100],
  ...
  try {
    ...
    if (barcode) {
      try {
        ...
        const communityProduct = Array.isArray(stored) ? stored.find((item) => String(item.barcode || "") === barcode) : null;
        if (communityProduct) {
          return res.status(200).json({
            product: { ...communityProduct, measures: servingMeasures(communityProduct.name, communityProduct.unit) },
            source: "community",
          });
        }
      } catch { /* Fall through to the public barcode directory if shared storage is unavailable. */ }
